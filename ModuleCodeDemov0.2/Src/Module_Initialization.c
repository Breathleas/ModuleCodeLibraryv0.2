...
//00h 上半区	
	...
	Internal_Write_MemMap(1,0x00);                   //版本未注明
  ...
  //22-23 GetTemperature()
	//24-25 保留位
	//26-27 GetSupplyVoltage()（可选）
	//28-29 保留位
	//30-33 随意
	//34-41 Rx Power GetRxPower() （可选）
	//42-49 Tx Bias  GetTxBias()  （可选）
	//50-57 Tx PWR   GetTxPWR()   （可选）
	//58-65 保留位
	//66-81 随意
	//82-85 保留位
  ...
  //89-92 Rx Software Application 选择 （可选） 
	Internal_Write_MemMap(93,0x00);     //93 低功耗模式,  软件LPMode无， 失能软件覆盖
